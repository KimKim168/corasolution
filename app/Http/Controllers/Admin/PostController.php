...
class PostController extends Controller implements HasMiddleware
{
            ...
            if ($image_files) {
                try {
                    foreach ($image_files as $image) {
                        $created_image_name = ImageHelper::uploadAndResizeImageWebp($image, 'images', 600);
                        PostImage::create([
        ...
        try {
            ...
            if ($imageFile) {
                ...
                if ($imageName && $post->image) {
                    ImageHelper::deleteImage($post->image, 'images');
                }
            }
    ...
    public function destroy_image(PostImage $image)
    {
        ...
        ImageHelper::deleteImage($image->image, 'images');
